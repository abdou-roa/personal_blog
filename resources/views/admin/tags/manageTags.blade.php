    ...
    <div class="cont p-5">
        ...
        <div class="categories-table d-flex flex-column align-items-center px-5">
            ...
            <div class="d-flex justify-content-end w-100 py-3">
                <a href="{{route('addTag')}}"><button class="btn btn-primary">Add Tag</button></a>
            </div>
                    ...
                    @foreach ($tags as $tag)   
                        <tr>
                            ...
                            <td class="d-flex justify-content-end">
                                <a href="{{route('editTag', $tag->tag_id )}}"><button class="btn btn-warning m-1">Edit</button></a>
                                
                                {{-- <a href=""><button class="btn btn-danger m-1">Delete</button></a> --}}

                                <form action="{{route('deleteTag', $tag->tag_id )}}" method="post" >
                                    @csrf
                                    @method('DELETE')
